...
public class MainActivity extends AppCompatActivity {
    ...
    //public Button history = findViewById(R.id.historia);
    //public Button wifi_list = findViewById(R.id.sieci);
    //public Button signal_power = findViewById(R.id.moc);

    public Button history;
    public Button wifi_list;
    public Button signal_power;
    public Button save;
    ...
    public void init()
    {
        ...
        signal_power = (Button) findViewById(R.id.power);
        signal_power.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent signal = new Intent(MainActivity.this, signal_power.class);
